...
Category: Frontend
Summary: CAReplicatorLayer is perhaps the most obscure of all the CALayers. However it is one of the coolest! This presentation show you how simple it is to create a custom activity indicator and animate it in few steps with CAReplicatorLayer. You’ll be amazed by its simplicity and power.
